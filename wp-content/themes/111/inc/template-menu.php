 ...
 * @return void
 */
function malcolmy_lite_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon"></i>
		</button>
		<?php
		$args = apply_filters( 'malcolmy_lite_main_menu_args', array(
			'theme_location'   => 'main',
			'container'        => '',
			'menu_id'          => 'main-menu',
			'fallback_cb'      => 'malcolmy_lite_set_nav_menu',
			'fallback_message' => esc_html__( 'Set main menu', 'malcolmy_lite' ),
		) );
 ...
 * @return void
 */
function malcolmy_lite_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', malcolmy_lite_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}
	?>
	...
	<nav id="footer-navigation" class="footer-menu" role="navigation">
		<?php
		$args = apply_filters( 'malcolmy_lite_footer_menu_args', array(
			...
			'depth'            => 1,
			'fallback_cb'      => 'malcolmy_lite_set_nav_menu',
			'fallback_message' => esc_html__( 'Set footer menu', 'malcolmy_lite' ),
		) );
 ...
 * @return void
 */
function malcolmy_lite_top_menu() {
 ...
 * @return string
 */
function malcolmy_lite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'malcolmy_lite_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'malcolmy_lite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'malcolmy_lite' ),
	), $context, $type );
 ...
 * @return void
 */
function malcolmy_lite_set_nav_menu( $args ) {
