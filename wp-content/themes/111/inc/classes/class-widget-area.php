...
if ( ! class_exists( 'Malcolmy_Lite_Widget_Area' ) ) {

	class Malcolmy_Lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'malcolmy_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$footer_area_visibility = get_theme_mod( 'footer_widget_area_visibility', malcolmy_lite_theme()->customizer->get_default( 'footer_widget_area_visibility' ) );

			if ( ! $footer_area_visibility && 'footer-area' === $area_id ) {
			...
			$area_id = apply_filters( 'malcolmy_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'malcolmy_lite_widget_area_classes', $classes, $area_id );
	...
	function malcolmy_lite_widget_area() {
		return Malcolmy_Lite_Widget_Area::get_instance();
	}

	malcolmy_lite_widget_area();
}
