 ...
 */
add_filter( 'template_include', array( 'Malcolmy_Lite_Wrapping', 'wrap' ), 99 );
add_filter( 'malcolmy_lite_wrap_base', 'malcolmy_lite_wrap_base_cpts' );
 ...
 */
function malcolmy_lite_template_path() {
	return Malcolmy_Lite_Wrapping::$main_template;
}
 ...
 */
function malcolmy_lite_template_base() {
	return Malcolmy_Lite_Wrapping::$base;
}

if ( ! class_exists( 'Malcolmy_Lite_Wrapping' ) ) {
	...
	class Malcolmy_Lite_Wrapping {
		...
		/**
		 * Initialize new instance of Malcolmy_Lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'malcolmy_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Malcolmy_Lite_Wrapping class.
		 *
		 * @since 1.0.0
		 *
		...
		public static function wrap( $main ) {
			...
			return new Malcolmy_Lite_Wrapping();
		}
	}
}
 ...
 */
function malcolmy_lite_wrap_base_cpts( $templates ) {
