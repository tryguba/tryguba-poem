(function($){
	...
	CherryJsCore.theme_script = {
		...
		swiper_carousel_init: function ( self ) {
			...
			jQuery('.malcolmy_lite-carousel').each( function() {
				var swiper = null,
		...
		subscribe_init: function( self ) {
			CherryJsCore.variable.$document.on( 'click', '.subscribe-block__submit', function( event ){
				...
				var $this       = $(this),
					...
					nonce      = form.find( 'input[name="malcolmy_lite_subscribe"]' ).val(),
				...
				$.ajax({
					url: malcolmy_lite.ajaxurl,
					type: 'post',
					dataType: 'json',
					data: {
						action: 'malcolmy_lite_subscribe',
						mail: mail,
						nonce: nonce
					},
					error: function() {
		...
		main_menu: function ( self, $mainNavigation ) {
			...
			if ( hasprop.call( window, 'malcolmy_lite' ) &&
					 hasprop.call( window.malcolmy_lite, 'more_button_options' ) &&
					 hasprop.call( window.malcolmy_lite.more_button_options, 'more_button_type' ) ) {
				switch( window.malcolmy_lite.more_button_options.more_button_type ) {
					case 'image':
						imgurl = window.malcolmy_lite.more_button_options.more_button_image_url;
						if ( window.malcolmy_lite.more_button_options.retina_more_button_image_url ) {
							srcset = ' srcset="' + window.malcolmy_lite.more_button_options.retina_more_button_image_url + ' 2x"';
						}
						moreMenuContent = '<img src="' + imgurl + '"' + srcset + ' alt="' + moreMenuContent + '">';
						hasimg = true;
					break;
					case 'icon':
						moreMenuContent = '<i class="fa ' + window.malcolmy_lite.more_button_options.more_button_icon + '"></i>';
						hasicon = true;
					break;
					case 'text':
					default:
						moreMenuContent = window.malcolmy_lite.more_button_options.more_button_text || moreMenuContent;
						hasimg = false;
						hasicon = false;
					break;
				}
		...
		to_top_init: function ( self ) {
			if ( $.isFunction( jQuery.fn.UItoTop ) ) {
				$().UItoTop({
					text: malcolmy_lite.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
